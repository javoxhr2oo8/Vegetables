...
const translations = {
    ru: {
        ...
        aboutText1: "О нас Zoroshop — 20 лет экспорта свежести из сердца Узбекистана С 2005 года компания Zoroshop надёжно поставляет свежие фрукты, овощи и зелень из Узбекистана на международные рынки. Мы обеспечиваем высочайшее качество и максимальную свежесть продукта на всех этапах — от поля до конечного покупателя.Наши сильные стороны• Собственные сельскохозяйственные угодья в наиболее плодородных регионах Узбекистана• Тесное сотрудничество с лучшими фермерскими хозяйствами страны• Полный контроль качества на всём пути: от семян до отгрузки• Широкая география поставок: Европа, Азия, Ближний Восток и страны СНГ Свежесть — наш главный приоритет Мы понимаем, насколько критична скорость в работе со свежей продукцией. Поэтому выстроили эффективную логистику: • Быстрые рефрижераторные автоперевозки — для стабильных крупных объёмов • Авиадоставка — для самой нежной зелени, ягод и экзотических фруктов Благодаря этому наш продукт доезжает до клиента в состоянии, максимально близком к только что собранному. Zoroshop — это 20 лет опыта, гарантированное качество и настоящий вкус солнечного Узбекистана. Мы гордимся тем, что помогаем нашим партнёрам каждый день предлагать своим покупателям действительно свежие и натуральные продукты. Готовы к сотрудничеству?  Напишите или позвоните нам — подготовим индивидуальное предложение в кратчайшие сроки.",
    ...
    en: {
        ...
        aboutText1: "Zoroshop — 20 Years of Exporting Freshness from the Heart of Uzbekistan Since 2005, Zoroshop has been a reliable supplier of fresh fruits, vegetables, and herbs from Uzbekistan to international markets. We ensure the highest quality and maximum freshness at every stage — from the field to the final customer.  Our Strengths Our own agricultural lands in the most fertile regions of Uzbekistan Close cooperation with the country’s leading farming enterprises Full quality control throughout the entire process: from seeds to shipment Wide export geography: Europe, Asia, the Middle East, and CIS countries Freshness Is Our Top Priority We understand how critical speed is when working with fresh produce. That’s why we have built an efficient logistics system: Fast refrigerated truck transportation for stable, large-volume deliveries Air freight for the most delicate herbs, berries, and exotic fruits Thanks to this approach, our products reach customers in a condition as close as possible to freshly harvested. Zoroshop stands for 20 years of experience, guaranteed quality, and the authentic taste of sunny Uzbekistan. We are proud to help our partners offer truly fresh and natural products to their customers every day. Ready to Cooperate? Write or call us — we will prepare a customized offer in the shortest possible time.",
