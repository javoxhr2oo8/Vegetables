...
const translations = {
    ru: {
        ...
        catalog: "Каталог",
        contacts: "Контакты",
        heroTitle: "Свежие овощи <br>прямо с грядки",
        heroSub: "Натуральные фермерские продукты без химии. Доставка в день заказа!",
        viewCatalog: "Выбрать овощи",
        aboutTitle: "Наша философия",
        aboutSub: "Выращено с любовью к земле",
        aboutText1: "Мы — семейная ферма, работающая с 2010 года. Наши угодья расположены в экологически чистом районе Подмосковья. Мы не используем химические удобрения и пестициды, только натуральные методы земледелия.",
        ...
        feature2: "Доставка за 3 часа",
        feature3: "Выращено с заботой",
        catalogTitle: "Сезонный урожай",
        ...
        footerText: "© 2023 Ферма 'Овощной Рай'. <br>Все овощи выращены с заботой о природе.",
    ...
    en: {
        ...
        catalog: "Catalog",
        contacts: "Contacts",
        heroTitle: "Fresh vegetables <br>straight from the garden",
        heroSub: "Natural farm products without chemicals. Delivery on the day of order!",
        viewCatalog: "Choose vegetables",
        aboutTitle: "Our philosophy",
        aboutSub: "Grown with love for the land",
        aboutText1: "We are a family farm operating since 2010. Our lands are located in an ecologically clean area of the Moscow region. We do not use chemical fertilizers or pesticides, only natural farming methods.",
        ...
        feature2: "Delivery in 3 hours",
        feature3: "Grown with care",
        catalogTitle: "Seasonal harvest",
